 ...
 */
?>
<div class="opigno-statistics-app-widget col col-3-out-of-4 clearfix" id="opigno-statistics-app-class-widget-number-of-interactions">
  <h2><?php print t('Number of interactions') . ' / ' . t('Score'); ?></h2>
  <div id="opigno-statistics-app-class-widget-number-of-interactions-chart" style="height: 250px;"></div>
    ...
    (function(){
      ...
      graph_config['hoverCallback'] = function(index, options, content) {
        ...
        return "<b>" + data.username + "</b>" +
          "<br/><?php print t('Number of interactions') ?>: " + data.number_of_interactions +
